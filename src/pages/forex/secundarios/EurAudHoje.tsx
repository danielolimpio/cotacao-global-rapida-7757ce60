...
const EurAudHoje = () => {
  return (
    <Layout>
      <SEO path="/forex/secundarios/eur-aud-hoje" />
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-foreground mb-2 flex items-center justify-center space-x-4">
            <span className="text-6xl">🇪🇺</span>
            <span>EUR/AUD Hoje</span>
            <span className="text-6xl">🇦🇺</span>
          </h1>
          <p className="text-lg text-muted-foreground">
            Acompanhe a cotação do Euro contra o Dólar Australiano em tempo real.
          </p>
        </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center justify-center space-x-3">
                ...
                <span className="text-xl font-bold">EUR/AUD - Gráfico em Tempo Real</span>
                <span className="text-3xl">🇦🇺</span>
              </CardTitle>
            </CardHeader>
            <CardContent>
