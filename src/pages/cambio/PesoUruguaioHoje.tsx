      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-bold text-success">$0.0250</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-bold text-destructive">$0.0240</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-bold text-success">+2.08%</p>
            </CardContent>
          </Card>
        </div>
