      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-bold text-success">$98.50</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-bold text-destructive">$91.95</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-bold text-primary">$1.8B</p>
            </CardContent>
          </Card>
        </div>
