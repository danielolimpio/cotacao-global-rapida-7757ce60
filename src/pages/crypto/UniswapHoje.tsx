      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-bold text-success">$8.78</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-bold text-destructive">$8.10</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-bold text-primary">$185M</p>
            </CardContent>
          </Card>
        </div>
